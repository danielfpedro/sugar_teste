...
<!--                 <li>
                ...
                <li class="dropdown sugar-navbar-main-control">
                    <a
                        ...
                        <?php // $this->Html->image($loggedinUser['profile_picture_path'], ['class' => 'img-circle sugar-navbar-profile-picture']) ?><?= $this->Sugar->shortName($loggedinUser['name']) ?> <span class="caret"></span>
                    </a>
